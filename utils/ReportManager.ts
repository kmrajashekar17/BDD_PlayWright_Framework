...
export class ReportManager {
    ...
    private static copyHistory():void{
        const historySource = 'reports/allure-report/history';
        const historyDestination = 'reports/allure-results/history';
    ...
    private static cleanExecution():void{
        const resultsFolder = 'reports/allure-results';
        ...
        Logger.info('Previous execution cleaned');
    }
    //#endregion
}
